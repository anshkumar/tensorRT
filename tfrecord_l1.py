...
json_path = "/Users/vedanshu/tfrecord/train_POT.json"
out_path = "/Users/vedanshu/tfrecord/out"
commodity_lst = ["tomato", "potato", "onion"]
writer = tf.python_io.TFRecordWriter("train_POT.record")
target_size = 1200
label_map = "/Users/vedanshu/tfrecord/label_map.pbtxt"
write_label_map = True

category = ['tomato','potato', 'onion']
